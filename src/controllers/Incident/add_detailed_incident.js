...
const add_detailed_incident = async (req, res) => {
  try {
    const {
      kit_id,
      incident_date,
    ...
    const savedIncident = await newIncident.save();
	   ...
	   // Update product quantities and calculate total used quantity
...
module.exports = add_detailed_incident;
