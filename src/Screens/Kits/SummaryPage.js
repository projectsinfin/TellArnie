...
//   // console.log("----route value55---", JSON.stringify(route.params));
...
//     console.log(JSON.stringify(payload), "--------5---pai");
//     if (
//       route.params?.payload?.allPropduct?.is_Empty_QrCode?.is_empty_QRCode
//         ?.is_empty === true
//     ) {
...
//       setIsLoadings(false);
//       setshowSuccess(true);
//       console.log("emptu status res =-", res);
//       return;
//     }
//     setIsLoadings(true);
...
const SummaryPage = ({ navigation, route }) => {
  ...
  // console.log("7643643734", route?.params?.payload?.allPropduct?.listData);
  ...
  const handleUPdateComplete = async () => {
    ...
    const payloadData = {
      ...
      // products: [
      //   {
      //     _id: "662f7daf54921e9a890752ee",
      //     kit_id: "5060131881126",
      //     brand: "Reliance Medical",
      //     description: "Large HSE dressing 18cm x 18cm sterile unboxed",
      //     product_picture:
      //       "https://tradeportal.reliancemedical.co.uk/images/product/source/317_HSE_Large_Contents.jpg",
      //     quantity: 2,
      //     // product_picture: "",
      //     current_quantity: 2,
      //     product_code: "317",
      ...
      //   },
      //   {
      //     _id: "662f7dae54921e9a890752e6",
      //     kit_id: "5060131881126",
      //     brand: "Reliance Medical",
      //     description:
      //       "Integral Aura Box - Small - Green/Green (removable dividers) ",
      //     product_picture: "",
      //     quantity: 1,
      //     current_quantity: 1,
      //     product_code: "2300",
      //     expiry_date: "2025-08-15T08:36:11.018Z",
      //   },
      // ],
    ...
    console.log("534543658734568", res);
    setIsLoadings(false);
    if (res.status === 200) {
      setshowSuccess(true);
    }
