...
const Signupbusiness = ({ navigation }) => {
  ...
  const handleSkip = () => {
    setisLoadings(true);
    console.log("register company res.payload.----", payloadValue);
  ...
  const handleRegisterCompany = (val) => {
    ...
    const payload = {
      ...
      // distributor_name: distributerLinkemail
      //   ? distributerLinkemail?.name
      //   : val.distributor_name,
      distributor_name: val.distributor_name,
      distributor_email: val.distributor_email?.toLowerCase(),
      // distributor_email: distributerLinkemail
      //   ? distributerLinkemail?.email
      //   : val.distributor_email?.toLowerCase(),
