...
function DistributorCreateUser() {
  const initialValues = {
    first_name: "",
    last_name: "",
    location_id: "fdsf",
  ...
  const handleRoleChange = (event) => {
    ...
    if (selectedRole === "Super Admin") {
      updatedPermissions = userPermissionsDistributor.map((permission) => permission.id);
    }
    setValues({
      ...values,
      assigned_role: selectedRole,
      permissions: updatedPermissions, // Update permissions based on selected role
    });
  };
                  ...
                  <Col key={curElm.id} className={curElm.column}>
                    <Form.Group name="permissions">
                      <Form.Check
                        ...
                        checked={
                          values.permissions.includes(curElm.id)
                        }
                      />
                    </Form.Group>
                  </Col>
