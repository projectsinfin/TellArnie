...
const AdminStack = () => {
  return (
    <Stack.Navigator
      initialRouteName={navigationString.admin}
      screenOptions={{
        headerShown: false,
      }}>
      {/* {AllStack(Stack)} */}
      ...
      <Stack.Screen
        name={navigationString.companyDetailsScreen}
        component={Screens.companyDetailsScreen}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name={navigationString.areaRiskCalculator}
        component={Screens.areaRiskCalculator}
      />

      <Stack.Screen
        name={navigationString.areaRiskCalculator2}
        component={Screens.areaRiskCalculator2}
      />
      ...
      <Stack.Screen
        name={navigationString.updateLocation}
        component={Screens.updateLocation}
        options={{ headerShown: false }}
      />
    </Stack.Navigator>
  );
